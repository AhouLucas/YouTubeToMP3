...
1) ffmpeg
    - On Arch distributions : `pacman -S ffmpeg`
    - On Debian distributions : `apt-get install ffmpeg`
2) yt-dlp
    - On Arch distributions : `pacman -S yt-dlp`
    - On Debian distributions : `sudo add-apt-repository ppa:tomtomtom/yt-dlp` & `sudo apt update` & `sudo apt install yt-dlp`
